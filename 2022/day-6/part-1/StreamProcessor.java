...
public class StreamProcessor {
    ...
    private static int quartetStartIndex = 0;
    private static int currentIndex = 0;
    private static final int flagMessageSize = 4;
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (currentIndex - quartetStartIndex < flagMessageSize && currentIndex < message.length()) {
            ...
            if (charIndexMap.keySet().contains(currentChar)) {
                ...
                quartetStartIndex = currentIndex = previousIndex + 1;
                charIndexMap.clear();
            } else {
